# [License](https://github.com/tips367/Sentiment-Analysis-SageMaker-Deployment/blob/master/LICENSE)
...
1. Clone the repository.
	```
		git clone https://github.com/tips367/Sentiment-Analysis-SageMaker-Deployment.git
	```
